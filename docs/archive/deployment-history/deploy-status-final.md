...
[HttpClient] Configured with base address: https://money-manager-api.up.railway.app/
```
...
### **API:**
```
Swagger: https://money-manager-api.up.railway.app//swagger
Health:  https://money-manager-api.up.railway.app//health
IP Info: https://money-manager-api.up.railway.app//api/discover-ip
```
