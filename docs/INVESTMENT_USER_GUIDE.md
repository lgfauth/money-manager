...
- Cotações atualizadas 3× ao dia (ações e FIIs B3)
...
> **⚠️ Importante:** O preço médio não muda na venda! Apenas na compra.
...
> **💡 Dica:** Para ações e FIIs B3 com ticker, os preços atualizam automaticamente 3× ao dia (12h, 15h e 18h). Use "Atualizar Agora" para forçar atualização imediata.
...
- ⚠️ Não considera isenções (vendas < R$ 20k/mês em ações)
...
- **Automaticamente:** 3× ao dia (12h, 15h, 18h)
...
**⚠️ Atenção:** Exclua apenas se não tiver mais o ativo. Se vendeu tudo, o sistema já zera a quantidade.
